...
class Box(object):
    ...
    def __init__(self, contents, volume):
        ...
        self.volume_0 = self.volume
        self.contents_0 = self.contents
    ...
    def append_string(self, additional_contents):
        ...
        if (len(self.contents)+len(additional_contents)) < self.volume:
            ...
            l = self.volume - len(self.contents)
            self.contents += additional_contents[:l]
            return additional_contents[l:]
    ...
    def shrink(self, new_volume):
        ...
        if new_volume < len(self.contents):
            ...
            return old_contents[new_volume:]
        return ""
    ...
    def reset(self):
        ...
        self.volume = self.volume_0
        self.contents = self.contents_0
